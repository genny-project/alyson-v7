...
import { ifConditionsPass } from '../../../utils-legacy';
import * as Components from '../../components';
import * as LegacyComponents from '../../components-legacy';

class RecursiveLegacy extends PureComponent {
  static propTypes = {
    component: string,
    props: object,
    children: any,
  ...
  handleReducePropInjection = ( result, current, index ) => {
    ...
    if ( isObject( result[current] ) || isObject( current )) {
      ...
      if ( result[current] && result[current].renderAsComponent ) {
        result[current] = <RecursiveLegacy {...result[current]} />;
...
export default connect( mapStateToProps )( RecursiveLegacy );
