import { isArray, isString, isObject, removeStartingAndEndingSlashes } from '../../../utils';
        ...
        try {
          ...
          if ( attr ) {
            ...
            * and remove the starting and ending slashes. */
              ...
              // console.log('baseEntityAttributes', baseEntityAttributes);
              
              const attribute = baseEntityAttributes.find( attribute => attribute.attributeCode === 'PRI_LAYOUT_DATA' ).value;
              
              // console.log('attribute', attribute);

              const data = isObject( attribute ) ? attribute : JSON.parse( attribute );
