...
import { KeycloakProvider, RetryTimer } from '../views/app_frame'
...
class AuthenticatedApp extends Component {
  ...
  render() {
    ...
    if (keycloak.fetching || keycloak.error) {
      return (
        <RetryTimer manualIncrement onAttemptRetry={this.handleAttemptRetry}>
    ...
    if (keycloak.fetched && !keycloak.data) {
